  ...
  return (
    ...
    >
      {/* This is what handles the sidebar gap on desktop */}
        <div
          className={cn(
          "relative h-[calc(100svh-var(--sidebar-top-offset))] w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-linear",
      ...
      <div
        className={cn(
          "fixed top-[var(--sidebar-top-offset)] bottom-0 z-10 hidden h-[calc(100svh-var(--sidebar-top-offset))] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "emr-scrollbar flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
